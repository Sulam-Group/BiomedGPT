...
data_train = pd.read_csv(
    "../../../datasets/iu_xray/train_images.tsv", delimiter="\t", names=header_list
)
data_test = pd.read_csv(
    "../../../datasets/iu_xray/test_images.tsv", delimiter="\t", names=header_list
)

with open(
    ".../../../datasets/finetuning/iu_xray/iu_xray_train_val.tsv", "w"
) as out_train, open(
    ".../../../datasets/finetuning/iu_xray/iu_xray_test.tsv", "w"
) as out_test:
