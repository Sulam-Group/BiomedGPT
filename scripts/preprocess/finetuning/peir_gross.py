...
data_train = pd.read_csv(
    "../../../datasets/peir_gross/train_images.tsv", delimiter="\t", names=header_list
)
data_test = pd.read_csv(
    "../../../datasets/peir_gross/test_images.tsv", delimiter="\t", names=header_list
)

with open(
    ".../../../datasets/finetuning/peir_gross/peir_gross_train.tsv", "w"
) as out_train, open(
    "../../../datasets/finetuning/peir_gross/peir_gross_val.tsv", "w"
) as out_val, open(
    "../../../datasets/finetuning/peir_gross/peir_gross_test.tsv", "w"
) as out_test:
