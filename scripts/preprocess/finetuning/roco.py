...
with open(".../../../datasets/finetuning/roco/roco_train.tsv", "w") as out_train, open(
    ".../../../datasets/finetuning/roco/roco_test.tsv", "w"
) as out_test, open(".../../../datasets/finetuning/roco/roco_val.tsv", "w") as out_val:
